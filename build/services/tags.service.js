...
class TagsService extends resolver_operations_service_1.default {
    constructor(root, variables, context) {
        super(root, variables, context);
        this.collection = constants_1.COLLECTION.TAGS;
    }
    items(active = constants_1.ACTIVE_VALUES_FILTER.ACTIVE) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.list(this.collection, 'tags', page, itemsPage, filter);
            return {
                info: result.info,
    ...
    unblock(unblock = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.update(this.collection, { id }, { active: unblock }, 'tag');
