...
class StripeCardService extends stripe_api_1.default {
    createToken(card) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.execute(stripe_api_1.STRIPE_OBJECTS.TOKENS, stripe_api_1.STRIPE_ACTION.CREATE, {
                card: {
                    number: card.number,
    ...
    create(customer, tokenCard) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.execute(stripe_api_1.STRIPE_OBJECTS.CUSTOMERS, stripe_api_1.STRIPE_ACTION.CREATE_SOURCE, customer, { source: tokenCard }).then((result) => {
                return {
                    status: true,
    ...
    get(customer, card) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.execute(stripe_api_1.STRIPE_OBJECTS.CUSTOMERS, stripe_api_1.STRIPE_ACTION.GET_SOURCE, customer, card).then((result) => {
                return {
                    status: true,
    ...
    update(customer, card, details) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.execute(stripe_api_1.STRIPE_OBJECTS.CUSTOMERS, stripe_api_1.STRIPE_ACTION.UPDATE_SOURCE, customer, card, details).then((result) => {
                return {
                    status: true,
    ...
    delete(customer, card) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.execute(stripe_api_1.STRIPE_OBJECTS.CUSTOMERS, stripe_api_1.STRIPE_ACTION.DELETE_SOURCE, customer, card).then((result) => {
                return {
    ...
    list(customer, limit = 5, startingAfter = '', endingBefore = '1') {
        return __awaiter(this, void 0, void 0, function* () {
            const pagination = this.getPagination(startingAfter, endingBefore);
            return yield this.execute(stripe_api_1.STRIPE_OBJECTS.CUSTOMERS, stripe_api_1.STRIPE_ACTION.LIST_SOURCE, customer, Object.assign({ object: 'card', limit }, pagination)).then((result) => {
                return {
                    status: true,
