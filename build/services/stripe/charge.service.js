...
class StripeChargeService extends stripe_api_1.default {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (userData && (userData).status) {
                ...
                if (payment.token !== undefined) {
                    ...
                    yield new customer_service_1.default().update(payment.customer, {
                        default_source: (_b = cardCreate.card) === null || _b === void 0 ? void 0 : _b.id
                    });
                    yield new card_service_1.default().removeOtherCards(payment.customer, ((_c = cardCreate.card) === null || _c === void 0 ? void 0 : _c.id) || '');
                }
                else if (payment.token === undefined && ((_d = userData.customer) === null || _d === void 0 ? void 0 : _d.default_source) === null) {
                    return {
                        status: false,
            ...
            payment.amount *= 100;
            return yield this.execute(stripe_api_1.STRIPE_OBJECTS.CHARGES, stripe_api_1.STRIPE_ACTION.CREATE, payment).then((result) => {
    ...
    listByCustomer(customer, limit, startingAfter, endingBefore) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.execute(stripe_api_1.STRIPE_OBJECTS.CHARGES, stripe_api_1.STRIPE_ACTION.LIST, Object.assign({ limit, customer }, pagination)).then((result) => {
                return {
                    status: true,
                    message: 'Lista cargada correctamente con los pagos  clientes seleccionados',
