...
const resolversMailMutation = {
    Mutation: {
        ...
        resetPassword(_, { email }, { db }) {
            return __awaiter(this, void 0, void 0, function* () {
                return new password_service_1.default(_, { user: { email } }, { db }).sendMail();
            });
        },
...
function verifyToken(token, id) {
    ...
    if (checkToken === constants_1.MESSAGES.TOKEN_VERIFICATION_FAILT) {
        return {
            status: false,
...
exports.default = resolversMailMutation;
